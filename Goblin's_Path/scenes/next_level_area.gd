...
func _ready():
	...
	print("SceneChangeAnimationParent: ", SceneChangeAnimationParent)
	print("Box: ", box)
	print("Timer label: ", timer_label)
	print("BG Music: ", bg_music)
...
func _on_body_entered(body):
	...
	if body.name == "Goblin":
		...
		get_tree().call_deferred("change_scene_to_file", "res://Goblin's_Path/scenes/Level 2.tscn")
		print_debug("DEBUG: Level 1 Completed")
